view: combined_vw {
  #sql_table_name: `sgcq-biengine-prj.upr_mdm_slog.vw_system_logs_reporting` ;;
  ...
  derived_table: {
    ...
    from  `sgcq-biengine-prj.upr_mdm_slog.vw_system_logs_reporting`
    union all
    select *
    ,'Dev' as 'Environment'
    from  `sgcd-biengine-prj.sit04_mdm_slog.vw_system_logs_reporting`
